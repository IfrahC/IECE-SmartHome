...
Text(container, text="Servo Status", grid=[0, 2], align="left", size=label_size, color=label_color)
servoStatus = Text(container, text="Closed", grid=[1, 2], align="right", size=value_size, color=value_color)
